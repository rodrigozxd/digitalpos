...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        $cashier_role = Role::create([ 'name' => 'Cajero#' . $business_id,
                            'business_id' => $business_id,
                            'guard_name' => 'web'
                        ]);
        ...
        //Add Default/Clientes varios for new business
        $customer = [
                        'business_id' => $business_id,
                        'type' => 'customer',
        ...
        InvoiceScheme::create(['name' => 'Por defecto',
                            'scheme_type' => 'en blanco',
                            'prefix' => '',
                            'start_number' => 1,
                            'total_digits' => 4,
                            'is_default' => 1,
        ...
        InvoiceLayout::create(['name' => 'Por defecto',
                        'header_text' => null,
                        'invoice_no_prefix' => 'Comprobante Nro.',
                        'invoice_heading' => 'Comprobante',
