...
<html lang="en">
  ...
  <body>
  	<div class="container">
		...
		<center>
			<h2>Verificando requisitos previos a la instalación...</h2><br/>
		</center>
	...
	<table class="table">
		...
		<tr>
			<td class="col-md-6">
				...
				?>
				¿El directorio de almacenamiento se puede escribir?
			</td>
			<td class="col-md-6">
				<?php
					if($is_writable){
		...
		<tr>
			<td>
				¿Se puede escribir en el directorio de caché?
				<?php
		...
		<tr>
			<td>
				¿El directorio de subidas se puede escribir?
				<?php
	...
	<center>
		...
		<p>
			<?php
				if($all_ok){
					echo "<span class='text-success'>Toda la configuración parece correcta. <a href=$install_link>Continuar</a></span>";
				} else {
					echo "<span class='text-danger'>Algunas configuraciones son incorrectas. Corríjalo y luego actualice esta página.</span>";
				}
			?>
		</p>
	</center>
