<div class="modal-dialog modal-lg" role="document">
  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('first_name', __( 'Nombre(s)/Razón social' ) . ':*') !!}
                {!! Form::text('first_name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'Nombre/Empresa S.A.' ) ]); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('mobile', __('Nro. Celular') . ':*') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-mobile"></i>
                </span>
                {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'placeholder' => __('Ingrese Nro.')]); !!}
            </div>
        </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::email('email', null, ['class' => 'form-control','placeholder' => __('Ingrese correo electrónico')]); !!}
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
