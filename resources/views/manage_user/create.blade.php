      ...
      <div class="col-md-2">
        <div class="form-group">
          {!! Form::label('surname', __( 'business.prefix' ) . ':') !!}
            {!! Form::text('surname', null, ['class' => 'form-control', 'placeholder' => __( 'Sr. Sra. Srta.' ) ]); !!}
        </div>
      </div>
      <div class="col-md-5">
        <div class="form-group">
          {!! Form::label('first_name', __( 'Nombre(s)' ) . ':*') !!}
            {!! Form::text('first_name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'Ingrese nombre(s)' ) ]); !!}
        </div>
      </div>
      <div class="col-md-5">
        <div class="form-group">
          {!! Form::label('last_name', __( 'Apellido(s)' ) . ':') !!}
            {!! Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => __( 'Ingrese apellido(s)' ) ]); !!}
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          {!! Form::label('email', __( 'Correo electrónico' ) . ':*') !!}
            {!! Form::text('email', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'Ingrese su correo electrónico' ) ]); !!}
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          {!! Form::label('confirm_password', __( 'business.confirm_password' ) . ':*') !!}
            {!! Form::password('confirm_password', ['class' => 'form-control', 'required', 'placeholder' => __( 'Confirme su ontraseña' ) ]); !!}
        </div>
      </div>
    </div>
      <div class="clearfix"></div>
